...
export default defineConfig({
  ...
  use: {
    ...
    // slowMo: 1000, // Uncomment to slow down tests by 1 second per action

    /* Launch options for better visibility */
    launchOptions: {
      // Uncomment the line below to see browser actions in slow motion
      // slowMo: 1000,

      // Uncomment to see browser console logs
      // args: ['--enable-logging'],

      // Uncomment to disable headless mode (always show browser)
      // headless: false,
    },
  },
